...
namespace std _GLIBCXX_VISIBILITY( default )
{
    ...
    */
    ...
    inline bool operator==( const _List_iterator<_Val> &__x, const _List_const_iterator<_Val> &__y ) _GLIBCXX_NOEXCEPT
    {
    ...
    _GLIBCXX_BEGIN_NAMESPACE_CXX11
        ...
        public:
            ...
            _List_base( _List_base &&__x, _Node_alloc_type &&__a ) : _M_impl( std::move( __a ) )
            {
                ...
                {
                    _M_init();
                } // Caller must move individual elements.
            }
        ...
        */
        ...
        public:
             ...
             */
            list( size_type __n, const value_type &__value, const allocator_type &__a = allocator_type() ) : _Base( _Node_alloc_type( __a ) )
            {
             ...
             */
            list( initializer_list <value_type> __l, const allocator_type &__a = allocator_type() ) : _Base( _Node_alloc_type( __a ) )
            {
          ...
          this->_M_inc_size(1);
            ...
            void _M_move_assign( list &&__x, false_type )
            {
                ...
                else
                {
                    ...
                    _M_assign_dispatch( std::__make_move_if_noexcept_iterator( __x.begin() ), std::__make_move_if_noexcept_iterator( __x.end() ), __false_type {} );
                }
            }
